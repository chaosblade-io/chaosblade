...
require (
	...
	github.com/chaosblade-io/chaosblade-exec-os v0.5.1-0.20200303021642-a0b0a31d5a93
	github.com/chaosblade-io/chaosblade-operator v0.5.0
	github.com/chaosblade-io/chaosblade-spec-go v0.5.1-0.20200413030726-04d0b230c5bc
