...
export const en: Dict = {
  ...
  // -- LiveThinkingPanel (web-only live CoT fold) -------------------
  ...
  // -- PhaseStepper (inject/recover pipeline progress strip) -------
  "phase.intent": "Intent",
  "phase.safety": "Safety",
  "phase.inject": "Inject",
  "phase.verify": "Verify",
  ...
  "review.uid_label": "experiment uid",
  ...
  "result.label.uid": "Experiment UID",
  ...
  "confirm.none": "None",
  "confirm.gate_badge": "safety gate",
  "confirm.kbd_hint": "Enter ↵ confirm · Esc cancel",
