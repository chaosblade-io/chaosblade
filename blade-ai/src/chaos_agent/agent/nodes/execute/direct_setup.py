...
from chaos_agent.agent.spec.fault_registry import is_memory_burn_scope
...
async def _collect_context(state: AgentState) -> dict:
    ...
    from chaos_agent.agent.nodes.execute.direct_execute import _fetch_pod_memory_limit_mb
    ...
    if is_memory_burn_scope(scope, blade_target) and kubeconfig:
